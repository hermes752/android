package com.example.cursomovil.terremoto2;
...
import com.example.cursomovil.terremoto2.Fragments.EarthQuakeListFragment;
...
public class DetailEarthQuake extends ActionBarActivity {
   ...
   MapsActivity maps;
    ...
    private void SetViews(){
        ...
        maps = (MapsActivity) getFragmentManager().findFragmentById(R.id.map);
